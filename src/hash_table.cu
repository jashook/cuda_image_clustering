...
int hash_table_insert(hash_table* table, void* key, void* data, size_t (*hash_function)(void*), void* (*memory_management)(size_t))
{
   ...
   {
      table->array[index % table->max_size].next = (hash_table_bucket*)memory_management(sizeof(hash_table_bucket));
...
/* ************************************************************************** */
/* ************************************************************************** */
/* Function: insert_ignore_collision                                          */
/*                                                                            */
/* Arguments: hash_table*, void* key, void* data, hash_function, malloc       */
/*                                                                            */
/* Return: int: Error Code                                                    */
...
{
   table->array = (hash_table_bucket*)memory_management(sizeof(hash_table_bucket) * size);
